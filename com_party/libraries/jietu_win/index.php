...
# 3. Set max-height thumbnail size to 800
#    webthumb.php?url=http://www.thumbnails.com&max_height=800
###############################################################

// Folder to save all thumbnails. 
// Must end with slash!!!
$thumbnails_folder = 'screens/';
...
$_REQUEST['url'] = "https://mp.weixin.qq.com";
...
//$website_url = "http://yancheng.99cfw.com";
...
|| filemtime ($cached_filename) + $cache_expire_time * 60 < time() ) {
  ...
  @exec('IECapt.exe --url=' . escapeshellarg($website_url) . ' --out=' . escapeshellarg($cached_filename). ' --max-height=' . intval($max_height));
