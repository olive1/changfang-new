<?php
/**
 * http://dev.umeng.com/push/android/api-doc#1
    $demo = new Demo("5a4f3313f43e487346000204", "jtvhzxzgl4rkwez608rccffdvyoddvmn");
...
class Tuisong {
	...
	function __construct($key_secret) {
		$this->appkey             = $key_secret['key'];
		$this->appMasterSecret    = $key_secret['secret'];
	...
	function sendAndroidBroadcast() {
		try {
			...
			print("Sending broadcast umeng, please wait...\r\n");
			$brocast->send();
			print("Sent SUCCESS\r\n");
		} catch (Exception $e) {
	...
	function sendAndroidUnicast() {
		try {
			...
			print("Sending unicast umeng, please wait...\r\n");
			$unicast->send();
			print("Sent SUCCESS\r\n");
		} catch (Exception $e) {
			print("Caught exception: " . $e->getMessage());
	...
	function sendAndroidFilecast() {
		try {
			...
			print("Sending filecast umeng, please wait...\r\n");
			$filecast->send();
			print("Sent SUCCESS\r\n");
		} catch (Exception $e) {
			print("Caught exception: " . $e->getMessage());
	...
	function sendAndroidGroupcast() {
		try {
			...
			print("Sending groupcast umeng, please wait...\r\n");
			$groupcast->send();
			print("Sent SUCCESS\r\n");
		} catch (Exception $e) {
			print("Caught exception: " . $e->getMessage());
	...
	function sendAndroidCustomizedcast() {
		try {
			...
			print("Sending customizedcast umeng, please wait...\r\n");
			$customizedcast->send();
			print("Sent SUCCESS\r\n");
		} catch (Exception $e) {
			print("Caught exception: " . $e->getMessage());
	...
	function sendIOSUnicast($device_tokens, $title, $key_value_list) {
		try {
     ...
     * 
     */
	function sendIOSCustomizedcast($alias_type, $alias, $title, $key_value_list) {
		try {
...
//$demo = new Tuisong("5a4f3313f43e487346000204", "jtvhzxzgl4rkwez608rccffdvyoddvmn");
//$demo->sendIOSCustomizedcast();
